...
```{r echo=FALSE, warning=FALSE, fig.width=10, fig.height=4, Univariate_Plots2}
...
```{r echo=FALSE, warning=FALSE, fig.width=10, fig.height=4, Univariate_Plots3}
...
```{r echo=FALSE, warning=FALSE, fig.width=10, fig.height=4, Univariate_Plots4}
...
```{r echo=FALSE, warning=FALSE, fig.width=10, fig.height=4, Univariate_Plots5}
...
```{r echo=FALSE, warning=FALSE, fig.width=10, fig.height=8, Univariate_Plots6}
...
```{r echo=FALSE, warning=FALSE, fig.width=10, fig.height=4, Univariate_Plots7}
...
```{r echo=FALSE, warning=FALSE, fig.width=10, fig.height=4, Univariate_Plots8}
...
```{r echo=FALSE, warning=FALSE, fig.width=10, fig.height=4, Univariate_Plots9}
...
```{r echo=FALSE, warning=FALSE, fig.width=10, fig.height=4, Univariate_Plots10}
...
```{r echo=FALSE, warning=FALSE, fig.width=5, fig.height=4,Univariate_Plots11}
# histogram for `pH`
...
```{r echo=FALSE, warning=FALSE, fig.width=5, fig.height=4, Univariate_Plots12}
...
```{r echo=FALSE, warning=FALSE, fig.width=5, fig.height=4, Univariate_Plots14}
...
```{r echo=FALSE, warning=FALSE, message=FALSE, fig.width=10, fig.height=10, Bivariate_Plots1}
...
```{r echo=FALSE, warning=FALSE, fig.width=10, fig.height=12, Bivariate_PlotsCor}
...
```{r echo=FALSE, warning=FALSE, fig.width=10, fig.height=4, Bivariate_Plots2}
...
```{r echo=FALSE, warning=FALSE, fig.width=10, fig.height=4, Bivariate_Plots3}
...
```{r echo=FALSE, warning=FALSE, fig.width=10, fig.height=4, Bivariate_Plots4}
...
```{r echo=FALSE, warning=FALSE, fig.width=5, fig.height=4, Bivariate_Plots5}
# boxplot for alcohol 
...
```{r echo=FALSE, warning=FALSE, fig.width=10, fig.height=4, Bivariate_Plots5_1}
# boxplot for `alcohol` 
...
```{r echo=FALSE, warning=FALSE, fig.width=10, fig.height=4, Bivariate_Plots6}
# boxplot for `density`
# (observations with different `quality` plotted separately)
...
```{r echo=FALSE, warning=FALSE, fig.width=10, fig.height=4, Bivariate_Plots6_1}
# boxplot for `density` (outliers removed)
# (observations with different `quality` plotted separately)
...
```{r echo=FALSE, warning=FALSE, fig.width=10, fig.height=4, Bivariate_Plots7}
...
```{r echo=FALSE, warning=FALSE, fig.width=10, fig.height=4, Bivariate_Plots7_1}
# boxplot for chlorides (outliers removed)
# (observations with different `quality3` plotted separately)
...
```{r echo=FALSE, warning=FALSE, fig.width=10, fig.height=4, Bivariate_Plots8}
...
```{r echo=FALSE, warning=FALSE, fig.width=10, fig.height=4, Bivariate_Plots8_1}
# boxplot for `volatile.acidity` (outliers removed)
# (observations with different `quality3` plotted separately)
...
```{r echo=FALSE, warning=FALSE, fig.width=5, fig.height=4, Multivariate_Plots1}
...
```{r echo=FALSE, warning=FALSE, fig.width=10, fig.height=4, Multivariate_Plots2}
# scattering plot of `residual.sugar` vs `density` 
...
```{r echo=FALSE, warning=FALSE, fig.width=5, fig.height=4, Multivariate_Plots3}
...
```{r echo=FALSE, warning=FALSE, fig.width=10, fig.height=4, Multivariate_Plots4}
# scattering plot of `density` vs `alcohol` 
# outlier removed and colored by `quality3` 
p1 <- ggplot(data = subset(df_wine, density <= 1.005), 
...
```{r echo=FALSE, warning=FALSE, Multivariate_Plots_lm1}
set.seed(123)
...
```{r echo=FALSE, warning=FALSE, Multivariate_Plots_lm2}
set.seed(321)
...
```{r echo=FALSE, warning=FALSE, fig.width=10, fig.height=4, Plot_One}
...
```{r echo=FALSE, warning=FALSE, fig.width=10, fig.height=4, Plot_Two}
# boxplot for `alcohol` 
# (observations with different `quality3` plotted separately)
p1 <- ggplot(data = df_wine, 
             aes(x = quality3, y = alcohol, fill = quality3)) + 
...
###5.5. Plot Three
```{r echo=FALSE, warning=FALSE, fig.width=10, fig.height=4, Plot_Three}
# scattering plot of `residual.sugar` vs `density` 
# outlier removed and colored by `quality3` 
p1 <- ggplot(data = subset(df_wine, residual.sugar <= 25), 
            aes(x = residual.sugar, y = density, color = quality3)) + 
